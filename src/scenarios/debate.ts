...
export const DebateScenario: ScenarioConfig = {
  ...
  inputs: {
    ...
    style: {
      ...
      type: "select",
      options: [
        { value: "friendly", label: "Friendly - Conversational, supportive, helps you practice with encouragement", mobileLabel: "Friendly" },
        { value: "aggressive", label: "Aggressive - Interrupts, challenges directly, tries to dominate", mobileLabel: "Aggressive" },
        { value: "academic", label: "Academic - Evidence-heavy, methodical, formal reasoning", mobileLabel: "Academic" },
        { value: "emotional", label: "Emotional - Appeals to feelings, uses stories and anecdotes", mobileLabel: "Emotional" },
        { value: "socratic", label: "Socratic - Uses questioning to trap you, forces you to defend assumptions", mobileLabel: "Socratic" },
        { value: "gish gallop", label: "Gish Gallop (Aggressive+) - Aggressive debate style with rapid-fire dubious claims", mobileLabel: "Gish Gallop" },
      ],
    ...
    difficulty: {
      ...
      type: "select",
      options: [
        { value: "easy", label: "Easy - Basic arguments, straightforward rebuttals", mobileLabel: "Easy" },
        { value: "medium", label: "Medium - Solid arguments, some strategic moves", mobileLabel: "Medium" },
        { value: "hard", label: "Hard - Advanced tactics, well-researched, strategic", mobileLabel: "Hard" },
      ],
