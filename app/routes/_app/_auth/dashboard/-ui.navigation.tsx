 ...
 * Using string paths directly for SSR compatibility.
 */
const ROUTES = {
  dashboard: "/_app/_auth/dashboard",
  debate: "/_app/_auth/dashboard/debate",
  settings: "/_app/_auth/dashboard/settings",
  billing: "/_app/_auth/dashboard/settings/billing",
} as const;
...
export function Navigation({ user }: { user: User }) {
  ...
  const isDashboardPath = matchRoute({ to: ROUTES.dashboard });
  const isDebatePath = matchRoute({ to: ROUTES.debate });
  const isSettingsPath = matchRoute({ to: ROUTES.settings });
  const isBillingPath = matchRoute({ to: ROUTES.billing });
